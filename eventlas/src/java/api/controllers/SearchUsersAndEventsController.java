 ...
 * @author craigbrookes
 */
public class SearchUsersAndEventsController extends AuthenticatedRequest<LinkedHashMap<String,Object>>{

    public SearchUsersAndEventsController(HttpServletRequest req) {
        super(req);
